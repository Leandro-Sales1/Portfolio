...
const CardAps = ({corBotao}) =>{
    return(
        <section className="flex flex-col items-center justify-center gap-4 md:gap-6">
            <div className="m-4 flex flex-col items-center justify-center  md:grid grid-cols-2 md:items-center md:m-8    lg:w-3/5 lg:m-auto">
                <div className="flex flex-col items-center justify-center gap-2 md:gap-4">
                    <img className="w-40 h-40 rounded-full  md:w-56 md:h-56" src="/imagens/fotoPrincipal.jpeg" alt="minha foto" />
                    <h1 className="text-center text-3xl md:text-4xl">Olá, sou o Sales, Dev. Front-End. </h1>
                </div>
                <div className="m-4 flex flex-col items-center justify-center gap-4 md:gap-7">
                    <h3 className="text-lg text-center md:text-xl">Sou amante de jogos e tecnologia desde a infância. Com o tempo, tenho me especializado cada vez mais na área de Engenharia de Software. Sendo um profissional bem-humorado, dedicado, organizado e sempre adepto a mudanças. </h3>
            ...
            <div className="m-5 flex flex-col items-center justify-center gap-4 md:gap-6">
