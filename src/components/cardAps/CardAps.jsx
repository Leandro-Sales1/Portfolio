        ...
        <section className="flex flex-col items-center justify-center gap-4 md:gap-6 lg:gap-8">
            <div className={`m-4 mb-0 flex flex-col items-center justify-center ${mostrarSecTitulo}`}>
                <div className="flex flex-col items-center justify-center gap-2 md:gap-4">
                    <img className="w-40 h-40 rounded-full shadow-sm shadow-black  md:w-56 md:h-56" src="/imagens/fotoPrincipal.jpeg" alt="minha foto" />
                    <h1 className="text-center text-3xl md:text-4xl">Leandro Sales</h1>
                    <h2 className="p-2 border border-black rounded-md text-sm shadow-sm shadow-black" style={{ backgroundColor: corBotao }}>Dev. Front-End.</h2>
                </div>
            ...
            <div className={`m-4 mt-0 flex flex-col items-center justify-center gap-4 md:gap-6 lg:mt-12 lg:gap-8 ${mostrarSecTec ? '' : 'hidden'}`}>
                ...
                <div className="flex flex-col items-center justify-center">
                    <h3 className="text-lg w-[90%] text-justify md:text-xl lg:w-4/5 ">Sou amante de jogos e tecnologia desde a infância. Com o tempo, tenho me especializado cada vez mais na área de Engenharia de Software, focando atualmente em desenvolvimento front-end. Sendo um profissional bem-humorado, dedicado, organizado e adepto a mudanças, estando sempre em busca de novos desafios para aprimorar minhas habilidades.</h3>
                </div>
